			...
			<div class="row">
				<div class="col-lg-3 col-md-4 col-6">
					<div class="header__bottom-logo">
						<a href="#"><img src="${classpath}/frontend/img/logo.jpg"
					...
					<div class="header__bottom-menu">
						<ul>
							<li class="header__bottom-menu-children"><a
								href="${classpath}/frontend/index.html">Trang chủ</a></li>
							<li class="header__bottom-menu-children"><a
								href="${classpath}/frontend/danhmuc.html">Thú cưng</a>
								<ul class="mega__subnav">
									<li class="mega__subnav-menu">
										<h4 class="mega__menu-title">Chó</h4>
										<ul class="mega__subnav-menu-2">
											<li><a href="${classpath}/frontend/danhmuc.html">Chó
													Corgi</a></li>
											<li><a href="${classpath}/frontend/danhmuc.html">Chó
													Beagle</a></li>
											<li><a href="${classpath}/frontend/danhmuc.html">Chó
									...
									<li class="mega__subnav-menu">
										...
										<ul class="mega__subnav-menu-2">
											<li><a href="${classpath}/frontend/danhmuc.html">Mèo
													Anh (Dài + Ngắn)</a></li>
											<li><a href="${classpath}/frontend/danhmuc.html">Mèo
													Chân Ngắn</a></li>
											<li><a href="${classpath}/frontend/danhmuc.html">Mèo
							...
							<li class="header__bottom-menu-children"><a
								href="${classpath}/frontend/lienhe.html">Liên hệ</a></li>
						</ul>
					</div>
				</div>
								...
								<div class="header__bottom-box-cart">
									<div class="header__cart-products">
										...
										<div class="cart-product-inner">
											<div class="cart-product__main">
												<div class="cart-product__thumb">
													<img src="${classpath}/frontend/img/products/1.jpg"
														class="cart-product-img">
												</div>
												<div class="cart-product__content">
													<a href="${classpath}/frontend/sanpham.html">
		...
		<div class="swiper mySwiper ">
			<div class="swiper-wrapper">
				<div class="swiper-slide .header__slider-imgs">
					<img src="${classpath}/frontend/img/slider-1.jpg" alt=""
						class="header__slider-img">
				</div>
				<div class="swiper-slide .header__slider-imgs">
					<img src="${classpath}/frontend/img/slider-2.jpg" alt=""
						class="header__slider-img">
				</div>
				<div class="swiper-slide .header__slider-imgs">
					<img src="${classpath}/frontend/img/slider-3.jpg" alt=""
						class="header__slider-img">
				</div>
				<div class="swiper-slide .header__slider-imgs">
					<img src="${classpath}/frontend/img/slider-4.jpg" alt=""
						class="header__slider-img">
				</div>
			</div>
